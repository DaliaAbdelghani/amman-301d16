...
function displayPics(){
  ...
  /* When replacing var with let the error is: Uncaught ReferenceError: rando is not defined
   this is because the variable rando was declared inside the block scope of while statement. Any variable declared with let inside a block scope { } is only defined inside the block scope, but outside the block scope it is not defined. 
  */
  console.log(viewed);
